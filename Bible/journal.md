...
**Chapters read:** 1–9 (all of Part 1: Hiding)
**Bible entries written:** `bible.md` — initial build
**Character profiles written:** ethan-calloway.md, maya-vasquez.md, zoe.md, jake.md, priya.md, rachel.md, dr-bowen.md, bret.md

---

## Mid-session corrections (between Sessions 1 and 2)

- **Rachel confirmed as Ethan's sister** (verified against Ch. 11). Family name: Calloway. Profile fully rewritten.
- **Ch. 11 detail:** Ethan was the one who found their mother. Added to ethan-calloway.md.
- **Faith thread (Ch. 11):** Rachel attends a small progressive congregation on the north side. Their mother took them to church. Ethan has drifted but not closed the door.
- **Profiles corrected** per author note: removed plot tracking, chapter tables, and "What We Don't Know Yet" sections from all character profiles. That information relocated to character-arcs.md (plot) and journal (open questions).
...
- Maya's medical specifics: ✅ CAIS, confirmed Chs. 12 and 25
- Rachel's identity and role: ✅ Ethan's sister, Ch. 11; best person, Ch. 29–30
- Dr. Bowen's role: ✅ supervisor, Chs. 16 and 26; ⚠️ gender still flagged
- Eileen's story: ✅ Ch. 28 — she knew from birth
...
- Diane and Clare: minor group members; profiles not written; no arcs recorded beyond first appearance.
